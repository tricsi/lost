...
namespace Game {
    ...
    on(window, 'load', () => {
        ...
        const sprite = new Sprite(ictx, src, canvas.width, () => {
            ...
            Hero.jetSprite = sprite.crop(64, 0, 48, 48, [[255, 204, 0]]);
            Bumm.sprite = sprite.crop(0, 152, 48, 16, [[255, 255, 102]]);
            Platform.sprite = sprite.crop(0, 80, 24, 8, [[0, 204, 0], [255, 204, 0]]);
            Enemy.sprite = sprite.crop(0, 48, 48, 16, [
                [255, 102, 102],
                [255, 102, 255],
                [102, 102, 255],
                [102, 255, 255],
